<h2><a href="https://www.geeksforgeeks.org/problems/java-hello-world4004/1?page=1&category=Java,Java-Collections,Java-Control-Flow,Java-BigInteger,Java-Strings,Java-Operators,Java-Class%20and%20Object&difficulty=School,Basic&sortBy=submissions">Java Hello World</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Display the most famous phrase of beginning any programming language, "Hello World" (without Quotes).</span></p>
